class OktawsBin < Formula
  ...
  if OS.mac?
      url "https://github.com/jonathanmorley/oktaws/releases/download/#{version}/oktaws-v#{version}-x86_64-apple-darwin.tar.gz"
  elsif OS.linux?
      url "https://github.com/jonathanmorley/oktaws/releases/download/#{version}/oktaws-v#{version}-x86_64-unknown-linux-musl.tar.gz"
  end
